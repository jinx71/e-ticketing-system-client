                            ...
                            <div className="card-body p-md-5">
                                <div className="row justify-content-center">
                                    ...
                                    <div className="col-md-10 col-lg-6 col-xl-5 order-1 order-lg-1">
                                        ...
                                        <button type="button" className="mx-auto mb-3 mb-lg-4 btn btn-primary w-100">Login</button>
                                        <button type="button" className="mx-auto mb-3 mb-lg-4 btn btn-primary w-100">Login With Google</button>
